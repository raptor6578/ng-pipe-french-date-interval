(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('date_format')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'date_format'], factory) :
    (global = global || self, factory(global['ng-date-interval'] = {}, global.vendor._angular_core, global.vendor._angular_common));
    ...
    var DateIntervalModule = /** @class */ (function () {
        ...
        DateIntervalModule = __decorate$1([
            core.NgModule({
    ...
    exports.DateIntervalModule = DateIntervalModule;
